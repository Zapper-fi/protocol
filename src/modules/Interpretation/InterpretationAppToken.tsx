      ...
      >
        ...
        >
          ...
          <p className="text-alt-color">
            App Token Interpreters are used to index app-centric token balances for users. This can be loans, deposits,
            pools, etc... The majority of these tokens do not have a market price; rather, they are priced based on the
        ...
        >
          {' '}
          <Media src="./videos/Position_Light.mp4" darkSrc="./videos/Position_Dark.mp4" isVideo height="440px" />
        </div>
      </div>
    </Section>
  );
