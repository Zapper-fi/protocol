...
export const PortfolioTracking: React.FC = () => {
  const [selectedType, setSelectedType] = React.useState<PortfolioTrackingType>(PortfolioTrackingType.AppHoldings);
        ...
        >
          ...
          >
            ...
            >
              ...
              <span
                style={{
                  fontSize: '24px',
                  marginTop: '-24px',
                  transform: selectedType === PortfolioTrackingType.AppHoldings ? 'rotate(180deg)' : 'initial',
                }}
              >
                ⌄
              </span>
            ...
            {selectedType === PortfolioTrackingType.AppHoldings && (
              <p className="text-alt-color">
                Track your holdings across various onchain applications. From DeFi, NFT-Fi to Staking. Powered by an
          ...
          >
            ...
            >
              ...
              <span
                style={{
                  fontSize: '24px',
                  marginTop: '-24px',
                  transform: selectedType === PortfolioTrackingType.Tokens ? 'rotate(180deg)' : 'initial',
                }}
              >
                ⌄
              </span>
            ...
            {selectedType === PortfolioTrackingType.Tokens && (
              <p className="text-alt-color">Track your token holdings across various chains.</p>
            )}
          </div>
          <hr />
          <div
          ...
          >
            ...
            >
              ...
              <span
                style={{
                  fontSize: '24px',
                  marginTop: '-24px',
                  transform: selectedType === PortfolioTrackingType.Nfts ? 'rotate(180deg)' : 'initial',
                }}
              >
                ⌄
              </span>
            ...
            {selectedType === PortfolioTrackingType.Nfts && (
              <p className="text-alt-color">Track your NFT holdings across various chains.</p>
            )}
          </div>
        </div>
