...
<TabPanel className="lg:flex gap-8">
<div className="basis-1/2 md:mt-14"> ## Access DeFi Holdings
...
<TabPanel className="lg:flex gap-8">
<div className="basis-1/2 md:mt-14"> ## Access Total Net Worth
...
<TabPanel className="lg:flex gap-8">
<div className="basis-1/2 md:mt-14"> ## Everybody Loves Claimables
