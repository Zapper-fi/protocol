  ...
  <TabPanels>
    <TabPanel className="lg:flex gap-8">
      <div className="basis-1/2 md:mt-14">
        ...
        Summarizes onchain transactions with human-readable descriptions. Ideal for activity feeds or detailed transaction views. [Learn More](/docs/api/human-readable-transactions/timeline-event)
